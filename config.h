...
static Key keys[] = {
    ...
    { MODKEY|ControlMask,    XK_Left,        viewtoleft,        {0} },                 /* super left          聚焦到左边的tag */
    { MODKEY|ControlMask,    XK_Right,       viewtoright,       {0} },                 /* super right         聚焦到右边的tag */
    ...
    { MODKEY,                XK_p,           spawn,             SHCMD("~/.config/rofi/powermenu.sh") },      /* rofi: 执行drun        */
